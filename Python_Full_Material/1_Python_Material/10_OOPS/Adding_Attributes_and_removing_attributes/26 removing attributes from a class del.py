...
ex:
    ...
    here del cannot delete an object
...
reference count.
 ...
 ex:1
     ...
     del t1    #means it decreases the reference count by 1,so R.C=0
            ...
            then that object is automatically removed by the garbage collector
 ...
 ex:2
     ...
     del t2 # RC becomes 0,i.e RC=0 ,gargabge collector removes the object and destructor executed
