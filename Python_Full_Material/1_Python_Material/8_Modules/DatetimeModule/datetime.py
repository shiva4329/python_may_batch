D'''Python Datetime module:
A date in Python is not a data type , but we can import a module named datetime to work with dates.
'''
#ex:1
...
x = datetime.datetime.now() #modulename.classname.methodnameprint(x)
